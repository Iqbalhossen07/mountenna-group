        ...
        <main class="flex-1 p-4 sm:p-6 overflow-y-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
               ...
               <?php
                ...
                <div class="bg-card-bg rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
                    data-aos="fade-up" data-aos-delay="100">
                    <div class="w-full h-48 overflow-hidden">
                        <img src="blogImage/<?php echo ($row['b_image']) ?>"
                            alt="Safe Driving Tips for City Traffic"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-bold text-text-dark mb-2 leading-tight">
                       <?php echo ($row['b_title']) ?>
                        ...
                        <div class="flex justify-end space-x-2 mt-auto pt-4 border-t border-gray-100">
                            <a href="blog_des.php?blog_des_id=<?php echo $row['id']; ?>" class="action-button bg-metric-blue-light hover:bg-blue-600"
                                title="Read More">
                                <i class="fas fa-book-reader"></i>
                            </a>
                            <a href="update_blog.php?blog_update_id=<?php echo $row['id']; ?>"  class="action-button bg-course-primary hover:bg-course-orange-light"
                                title="Edit Post">
                                <i class="fas fa-edit"></i>
                        </a>
                            <a href="logics.php?blog_delete_id=<?php echo $row['id']; ?>" onclick="alert('Are you sure? <?php echo ($row['b_title']) ?> has been deleted?')"  class="action-button bg-metric-red-dark hover:bg-red-700" title="Delete Post">
